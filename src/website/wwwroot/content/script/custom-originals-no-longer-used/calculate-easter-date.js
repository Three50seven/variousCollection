...
function AppViewModel() {
    ...
    self.prevYear = function () {
        self.yearToCalculate(self.yearToCalculate() - 1);
    ...
    function sortCalendar(sortDirection) {
    ...
    function getEasterDate(currentVal) {
    ...
    function getNumberOfSundaysAfterPentacost(finalEasterDate) {
    ...
    function getEasterSeasonDates(currentVal) {
    ...
    function getFirstSundayOfAdvent(yearToCalculate) {
    ...
    function getChristmasSeasonDates(yearToCalculate) {
    ...
    function getDayOfWeekName(weekDayNumber) {
    ...
    function isValid() {
        ...
        if (isNumber(currentDateEntered)) {
